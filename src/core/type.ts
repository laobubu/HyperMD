...
declare module "codemirror" {
  ...
  var hyperMDModes: { [mode: string]: CodeMirror.Mode<any> };
  ...
  var keyMap: { [keymapName: string]: HyperMDKeyMap };
  var hyperMDCommands: CommandFunctions;
  ...
  function normalizeHyperMDKeyMap(keymap: HyperMDKeyMap): object;
