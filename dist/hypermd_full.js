(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('codemirror'), require('codemirror/mode/gfm/gfm'), require('codemirror/addon/mode/overlay'), require('hypermd')) :
  typeof define === 'function' && define.amd ? define(['exports', 'codemirror', 'codemirror/mode/gfm/gfm', 'codemirror/addon/mode/overlay', 'hypermd'], factory) :
  (factory((global.HyperMD = {}),global.CodeMirror,null,null,global.HyperMD));
}(this, (function (exports,CodeMirror,gfm,overlay,hypermd) { 'use strict';
  ...
  function fromTextArea(textArea, config) {
      ...
      if (typeof cm['hmdHoverInit'] === 'function')
          { cm.hmdHoverInit(); }
      // (addon) click
      // (dependencies) addon/readlink
   ...
   */
  function Getter(name, ClassCtor) {
      return function (cm) {
          if (!cm.hmd)
              { cm.hmd = {}; }
          if (!cm.hmd[name])
              { cm.hmd[name] = new ClassCtor(cm); }
          return cm.hmd[name];
      };
  }
  ...
  /** HYPERMD ADDON DECLARATION */
  var AddonAlias$1 = "insertFile";
  var AddonClassCtor$1 = InsertFile;
  var OptionName = "hmdInsertFile";
  var getAddon$1 = hypermd.Addon.Getter(AddonAlias$1, AddonClassCtor$1);
  CodeMirror.defineOption(OptionName, false, function (cm, newVal) {
      ...
      var newCfg = hypermd.Addon.migrateOption(newVal, defaultOption);
      ///// apply config
