...
test.add(
  "No leading/tailing spaces in tag name",
  _T(`#Bad # #Good\\ #`, [
    ["#", "formatting formatting-hashtag hashtag hashtag-begin meta"],
...
test.add(
  "Tag name can't be pure decimal, unless using two hash symbol",
  _T(`#15 xyz#abc #12 #34# #56 xyz#`, [
    ["#", ""],
    ["15", ""],
    [" ", ""],
    ["xyz", ""],
...
test.add(
  "Tags can't be inside code or link href",
  _T("[link](hey #you) `Code #abcd `", [
...
test.add(
  "Break a tag with invalid chars(eg. comma)",
  _T("#gwegwe,ABC  #DEF, HI#z\nlorem", [
    ["#", "formatting formatting-hashtag hashtag hashtag-begin meta"],
